...
public class SockMerchantSolution {
    ...
    /**
     * This function takes two params, an array and its length. Using a hash set (linear time lookup, add, and removal) we take a running count of like pairs and return the total. 
     * Each time a pair is found remove that element from the set so that the order of the array does not matter
