...
public class CountValleysSolution {
    ...
    /**
     * This solution takes advantage of the idea that any time you end up at sea level and the last check was uphill you had to have been in a valley.
     * So for each time you altitude (var alt) reaches zero from going uphill, add a valley to the count
